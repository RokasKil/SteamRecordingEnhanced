...
public static class EventPriorities
{
    ...
    public const uint FATE_COMPLETE_PRIORITY = 8;
    public const uint LEVEL_UP_PRIORITY = 7;
    public const uint DUTY_STARTED_PRIORITY = 6;
    public const uint DUTY_WIPED_PRIORITY = 6;
    public const uint DUTY_COMPLETE_PRIORITY = 6;
    public const uint PLAYER_DIED_PRIORITY = 5;
